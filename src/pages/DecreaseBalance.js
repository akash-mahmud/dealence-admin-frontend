...
function DecreaseBalance() {
  ...
  const subMitHandel = async (e) => {
    ...
    const { data } = await axios.post(
      `/ea/user/data/decrease/balance/data/${id}`,
      {
        amount,
      },
      {
          ...
          <>
            ...
            <div className="row">
              <div className="col-md-6 mt-4">
                ...
                <Alert severity="info">{`Note: You need to remeber that your entered amount will be decreased from the use's balance directly. You should use this just for emergency.
         `}</Alert>
              </div>
            </div>
          </>
